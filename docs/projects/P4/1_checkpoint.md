...
Once you're all set up, follow the instructions in this [Google Doc](https://docs.google.com/document/d/1tuTWL4ZT7Z-p8rayoU3FcHyJsQTFPPcOnJuLujL-hIw/edit?usp=sharing) to create a copy of the starter python notebook. Only one team member needs to do this, and the team should collaborate using the notebook, once your copy has been created.
...
Given the unpredictable nature of LLM responses, it is crucial to test whether your application can handle a range of outcomes. Your notebook should also include tests for your code. We have provided some starter code for this.
...
You should submit a .ipynb copy of your notebook (with outputs) to Gradescope.
...
4. **Implementation Plan:**
  ...
  `Ctrl-Shift-F` is your friend here; if you're struggling, look back at [lecture 2](https://cmu-17313q.github.io/assets/pdfs/02-software-archeology-and-anthropology.pdf) and [recitation 4](https://docs.google.com/presentation/d/1U7k2tFHvEzDtZGeVC6SWi0eeuzOzFBoMLom5rk_uZQw) to get some tips on how to work through NodeBB's codebase.
...
6. **LLM Integration Plan:**
    ...
    Your team should consider **<number of people in your team>** different models to use in the new feature. Test the pros and cons of each of these models using the notebook, on top of cross-referencing with resources online (such as benchmarks) to find what would be the best possible model for your use case. You may also test out different prompts as well. **Each teammate** should run the notebook on a different model and record their results in this design doc. You can report the raw evaluation scores or make some plots if you wish.<BR>
...
- [ ] A notebook completing all of the setup and basic LLM experiment steps outlined by the previous section
