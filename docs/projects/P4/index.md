...
To get setup, you will need to setup your Azure NodeBB instance and set up LLM use through Azure. You should already have done both of these for P3 and recitation 7, but you should refer to these two documents if you don't have something set up properly.

1. [Azure Deployment Instructions](https://docs.google.com/document/d/19nnfaVRHDe4-y5zAK9FcPLxEvhuli81sj3FesTLhO3g/edit?usp=sharing) on setting up NodeBB instance on Azure
2. [Recitation 7 Instructions](https://docs.google.com/document/d/189pgRvykpltGc3dBXVy-m34g9JEzgg4z05PYRoEIb6M/edit?tab=t.0#heading=h.oij9rqx8vz75) on setting up Azure for LLM use

Once you're all set up, open the Colab notebook using [this link](https://colab.research.google.com/drive/1-tGUQqIRSB_Ge6lFDmgxGg9z6KGQzM9I?usp=sharing). Click on File --> Save as a copy in Drive to create your own copy that you will work on. Only one team member needs to do this, and the team should collaborate using this notebook. Click on Share and make sure the Colab notebook is **editable** by anyone in Carnegie Mellon University.

Now, you should be ready to experiment with LLMs! Follow the instructions in the notebook through the end of the Basic LLM Experiment.
