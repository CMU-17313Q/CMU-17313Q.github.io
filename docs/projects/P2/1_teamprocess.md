...
On the 17-313 Slack workspace, your team mentors should have created a **private** Slack channel that includes all your team members and them named `#team-<teamname>`.
...
Then, document these functional requirements in the form of user stories that follow the guidelines discussed in [lecture](https://cmu-17313q.github.io/assets/pdfs/04-project-planning.pdf). All of your user stories should be in the format of "As a [role], I want [function], so that [value]".
