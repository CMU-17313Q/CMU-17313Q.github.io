...
**Project Report and Presentation** – due Wednesday, December 10th, 11:59pm
...
**Presentation Date** – Wednesday, December 10th, 8:30-11:30 am, during exam timeslot

**Reflection** – due Wednesday, December 10th, 11:59pm
...
!!! warning "Presentation Attendance"
    For full credit, you would have to be on time for the presentation session (within 10 minutes of start time). If you are unable to attend in-person, you have to send an email with justification to the instructor  **at least a week before your final exam timeslot** so that appropriate arrangements can be made. Exceptions to notification deadline will only be made for unforseeable circumstances.
...
You must upload your slides as **a single PDF document** to Gradescope by **Wednesday, December 10th, 11:59pm**.
...
10.	**Extra Credit**
Evidence that your changes have been accepted into the code base of the open source project in forms of links or screenshots. **Note: You can also send the merged PR link to the instructors and CAs via Slack over Group DM or e-mail(to all) by 15th Dec 1pm to claim this bonus as well**
...
!!! warning "Use of Generative AI Forbidden"
    The use of generative AI tools for this part of the assignment is forbidden, and will be considered to be an academic integrity violation.
